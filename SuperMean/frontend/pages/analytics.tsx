...
const Analytics = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-background to-accent dark:from-gray-900 dark:via-gray-800 dark:to-indigo-900 transition-colors duration-500">
      <nav className="bg-white/90 dark:bg-gray-900/90 shadow-sm rounded-b-xl px-4 py-2 flex justify-between items-center">
        <h1 className="text-2xl font-bold text-indigo-700 dark:text-indigo-300 tracking-tight">Analytics</h1>
      ...
      <main className="max-w-5xl mx-auto py-10 px-4">
        <section className="mb-8">
          <h2 className="text-3xl font-bold mb-2 text-indigo-700 dark:text-indigo-300">Performance Metrics</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold mb-2 text-indigo-700 dark:text-indigo-300">Usage Statistics</h2>
          <div className="card bg-white dark:bg-gray-900 min-h-[120px] flex items-center justify-center text-gray-500 dark:text-gray-400">
            <span>Usage statistics coming soon.</span>
          </div>
        </section>
      </main>
    </div>
